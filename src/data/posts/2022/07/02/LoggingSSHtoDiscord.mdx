...
import DISCORD_SSH_LOGGING from '/posts/2022/07/02/discord-ssh-logging-animated.webp'
...
![How to create a Discord webhook GIF](/posts/2022/07/02/discord-webhook-creation-animated.webp)
...
<Image src={DISCORD_SSH_LOGGING.src} alt="SSH webhook log example" width={1920} />

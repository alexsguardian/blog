...
![Installing Docker GIF](caddy_docker-install-animated.webp)
...
![Cloudflare Tunnel Creation Wizard Part 1](caddy_cf_tunnel-setup-1-animated.webp)
...
![Edit Docker Run Command for the Tunnel](caddy_cf_copy-token-animated.webp)
...
![Local Tunnel Connecting to Cloudflare](caddy_cf_tunnel-connect-animated.webp)
